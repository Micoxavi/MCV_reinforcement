...
class DQN(nn.Module):
    ...
    """
    def __init__(self, input_size: tuple, nb_actions: int) -> None:
        """
        ...
        self.fc4 = nn.Linear(input_size[1] * input_size[2] * 64, 512)
        self.fc5 = nn.Linear(512, nb_actions)
