"""
This script contains the code for the AtariWraper and has been obtained from 
https://stable-baselines3.readthedocs.io/en/master/_modules/stable_baselines3/common/atari_wrappers.html#AtariWrapper

This code is currently not being used and it is here only to understand how the AtariWrapper works.
"""
